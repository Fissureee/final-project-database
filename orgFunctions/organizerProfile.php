...
if (isset($_POST['editUser'])) {
    ...
    // Perform the update
    $updateQuery = $conn->prepare("UPDATE Users SET UserName = ?, FirstName = ?, LastName = ?, Email = ?, PhoneNumber = ? WHERE UserID = ?");
    $updateQuery->execute([$editedUsername, $editedFirstName, $editedLastName, $editedEmail, $editedPhoneNumber, $editedUserID]);
